              ...
              <div class="card-body p-5 text-center">
                ...
                <div class="mb-md-5 mt-md-4 pb-5">
                  ...
                  <div data-mdb-input-init class="form-outline form-white mb-4">
                    <input type="correo_institucional" name="correo_institucional" id="typeEmailX" class="form-control form-control-lg" placeholder="Correo"/>
                  </div>

                  <div data-mdb-input-init class="form-outline form-white mb-4">
                    <input type="password" name="contrasena" id="typePasswordX" class="form-control form-control-lg" placeholder="Contraseña"/>
                  </div>
