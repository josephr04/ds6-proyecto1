...
if ($cedula) {
    $sql = $conexion->query("SELECT * FROM empleados WHERE cedula = '$cedula'");
    if ($sql && $sql->num_rows > 0) {
        $datos = $sql->fetch_assoc();
        // Descomponer la cédula si existe
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <input type="number" class="form-control text-center" name="tomo" required style="max-width: 90px;" 
                                           oninput="this.value = this.value.slice(0, 4)" value="<?= $tomo ?? '' ?>">
                                    <span>-</span>
                                    <input type="number" class="form-control text-center" name="asiento" required style="max-width: 100px;" 
                                           oninput="this.value = this.value.slice(0, 5)" value="<?= $asiento ?? '' ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="apellidoc" id="apellidoc" 
                                           value="<?= $datos['apellidoc'] ?? '' ?>" oninput="this.value = validarSoloLetras(this.value.slice(0, 25))">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="celular" value="<?= $datos['celular'] ?? '' ?>" 
                                       required oninput="this.value = validarSoloNumeros(this.value.slice(0, 8))">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Teléfono</label>
                                <input type="text" class="form-control" name="telefono" value="<?= $datos['telefono'] ?? '' ?>" 
                                       required oninput="this.value = validarSoloNumeros(this.value.slice(0, 7))">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control" name="correo" value="<?= $datos['correo'] ?? '' ?>" 
                                       required oninput="this.value = this.value.slice(0, 40)">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="casa" value="<?= $datos['casa'] ?? '' ?>" 
                                       oninput="this.value = validarSoloNumeros(this.value.slice(0, 10))">
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="f_contra" value="<?= $datos['f_contra'] ?? '' ?>">
                            </div>
