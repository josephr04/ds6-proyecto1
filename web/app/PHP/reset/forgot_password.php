...
<body>
  <section class="d-flex justify-content-center align-items-center vh-100">
      <form action="../functions/recuperar_contrasena.php" method="POST">
          <div class="card p-4" style="max-width: 500px;">
              <h2 class="text-center mb-4">Recuperar Contraseña</h2>
              <div class="mb-3">
                  <p class="text-center text-muted mb-4">Ingresa tu correo electrónico y se te enviará un enlace para recuperar tu cuenta.</p>
